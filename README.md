...
Android 本地记账应用，Kotlin + Jetpack Compose + Room。当前版本 `0.6.0`（versionCode 10），奶油手账与糯云团桌宠。
...
v0.6.0 新增图片与悬浮截图记账、远程公告信箱、按日翻页与统计明细优化。详见 [版本说明](docs/RELEASE_0_6_0.md) 和 [公告运营说明](docs/ANNOUNCEMENTS.md)。
